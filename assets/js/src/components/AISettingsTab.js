	...
	return (
		<div className="ai-settings-tab">
			<Section
				...
				description={ __(
					'پیکربندی و اتصال به سرویس هوش مصنوعی ChatGPT',
					'tabesh-v2'
				) }
			>
				<FormGroup
				...
				<FormGroup
					...
					description={ __(
						'نسخه مدل هوش مصنوعی مورد استفاده',
						'tabesh-v2'
					) }
				>
					<TextInput
				...
				<FormGroup label={ __( 'فعال‌سازی', 'tabesh-v2' ) }>
					<Checkbox
						...
						onChange={ handleChange }
						label={ __(
							'استفاده از هوش مصنوعی فعال است',
							'tabesh-v2'
						) }
					/>
				</FormGroup>
			...
			>
				...
				<FormGroup
					...
					description={ __(
						'دستورالعمل اولیه برای هوش مصنوعی',
						'tabesh-v2'
					) }
				>
					<TextArea
						...
						rows={ 6 }
						placeholder={ __(
							'شما یک دستیار هوشمند برای مدیریت سفارشات چاپ هستید...',
							'tabesh-v2'
						) }
					/>
				</FormGroup>
