		...
		<div className="firewall-settings-tab">
			...
			>
				...
				<FormGroup
					...
					description={__('تعداد مجاز درخواست در هر دقیقه', 'tabesh-v2')}
				>
					<TextInput
				...
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('حفاظت در برابر حملات Brute Force', 'tabesh-v2')}
					/>
				</FormGroup>
			</Section>
		</div>
	...
	return (
		<div className="file-settings-tab">
			<Section
				...
				description={__('مدیریت آپلود و دانلود فایل‌ها', 'tabesh-v2')}
			>
				<FormGroup
					label={__('حداکثر حجم فایل (MB)', 'tabesh-v2')}
					description={__('حداکثر حجم مجاز برای آپلود فایل', 'tabesh-v2')}
				>
					<TextInput
						name="max_file_size"
				...
				<FormGroup
					...
					description={__('فرمت‌های مجاز جدا شده با کاما', 'tabesh-v2')}
				>
					<TextInput
				...
				<FormGroup
					...
					description={__('مسیر ذخیره فایل‌های آپلود شده', 'tabesh-v2')}
				>
					<TextInput
						name="upload_path"
				...
				<FormGroup
					...
					description={__('تعداد روزهای نگهداری فایل‌ها قبل از حذف خودکار', 'tabesh-v2')}
				>
					<TextInput
			...
			>
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('مشتریان می‌توانند سفارشات خود را مشاهده کنند', 'tabesh-v2')}
					/>
				</FormGroup>
				...
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('مشتریان می‌توانند سفارشات را لغو کنند', 'tabesh-v2')}
					/>
				</FormGroup>
				...
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('مدیران می‌توانند سفارشات را حذف کنند', 'tabesh-v2')}
					/>
				</FormGroup>
				...
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('کارمندان می‌توانند سفارشات را ویرایش کنند', 'tabesh-v2')}
					/>
				</FormGroup>
				...
				<FormGroup>
					<Checkbox
						...
						onChange={handleChange}
						label={__('سفارشات نیاز به تایید دارند', 'tabesh-v2')}
					/>
				</FormGroup>

				<FormGroup
					label={__('نقش‌های مجاز برای تایید', 'tabesh-v2')}
					description={__('نقش‌های WordPress مجاز برای تایید سفارشات', 'tabesh-v2')}
				>
					<TextInput
						name="approval_roles"
	...
	return (
		<div className="import-export-settings-tab">
			<Section
				...
				description={__('مدیریت برون‌ریزی و درون‌ریزی داده‌ها', 'tabesh-v2')}
			>
				<FormGroup>
					<Checkbox
						name="allow_export"
				...
				<FormGroup
					...
					description={__('فاصله زمانی پشتیبان‌گیری خودکار', 'tabesh-v2')}
				>
					<TextInput
				...
				<FormGroup
					label={__('تعداد نسخه‌های پشتیبان نگهداری شده', 'tabesh-v2')}
					description={__('حداکثر تعداد فایل‌های پشتیبان برای نگهداری', 'tabesh-v2')}
				>
					<TextInput
						name="max_backups"
