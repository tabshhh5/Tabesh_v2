	...
	return (
		<div className="pricing-settings-tab">
			<Section
				...
				description={__('تنظیمات کلی مربوط به قیمت‌گذاری محصولات', 'tabesh-v2')}
			>
				<FormGroup
				...
				>
					...
					>
						<option value="before">{__('قبل از عدد', 'tabesh-v2')}</option>
						<option value="after">{__('بعد از عدد', 'tabesh-v2')}</option>
					</select>
				</FormGroup>

				<FormGroup
					label={__('تعداد اعشار', 'tabesh-v2')}
					description={__('تعداد ارقام اعشار در قیمت‌ها', 'tabesh-v2')}
				>
					<TextInput
						name="decimals"
			...
			>
				...
				<FormGroup
					...
					description={__('درصد مالیات بر ارزش افزوده', 'tabesh-v2')}
				>
					<TextInput
						name="tax_rate"
				...
				<FormGroup
					...
					description={__('حداکثر درصد تخفیف قابل اعمال', 'tabesh-v2')}
				>
					<TextInput
						name="max_discount"
			...
			<Section
				...
				description={__('تنظیمات تخفیف بر اساس تعداد سفارش', 'tabesh-v2')}
			>
				<FormGroup>
					<Checkbox
				...
				<FormGroup
					...
					description={__('تعریف محدوده‌های تخفیف به صورت JSON', 'tabesh-v2')}
				>
					<TextArea
			...
			>
				<FormGroup
					...
					description={__('هزینه پایه ارسال محصولات', 'tabesh-v2')}
				>
					<TextInput
				...
				<FormGroup
					...
					description={__('حداقل مبلغ سفارش برای ارسال رایگان', 'tabesh-v2')}
				>
					<TextInput
